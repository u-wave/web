...
const onRemoveFromPlaylist = playlist => (media, selection) => removeMedia(playlist, selectionOrOne(media, selection));
const onMoveMedia = playlist => (media, opts) => moveMedia(playlist, media, opts);
const onMoveToFirst = playlist => (media, selection) => moveMedia(playlist, selectionOrOne(media, selection), { at: 'start' });
const onMoveToLast = playlist => (media, selection) => moveMedia(playlist, selectionOrOne(media, selection), { at: 'end' });
const onEditMedia = playlist => media => editMedia(playlist, media);
