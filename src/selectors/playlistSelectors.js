...
export const activePlaylistSelector = createSelector(
  ...
  activePlaylistIDSelector,
  activeMediaSelector,
  (playlists, activeID, activeMedia) => mergePlaylistItems(playlists.playlists[activeID], activeMedia),
);
...
export const selectedPlaylistSelector = createSelector(
  ...
  selectedPlaylistIDSelector,
  selectedMediaSelector,
  (playlists, selectedID, selectedMedia) => mergePlaylistItems(playlists.playlists[selectedID], selectedMedia),
);
